...
describe("#routes - test site for api response", () => {
  ...
  test(`GET /index - should response with ${pages.homeHTML} file stream`, async () => {
    const params = TestUtil.defaulHandleParams();
    params.request.method = "GET";
  ...
  test(`POST /unknown - give an inexistent route it should response 404`, async () => {
    const params = TestUtil.defaulHandleParams();
  ...
  describe("exceptions", () => {
    test("given inexistent file it shoud respond with 404", async () => {
      const params = TestUtil.defaulHandleParams();
      params.request.method = "GET";
    ...
    test("given an error it shoud respond with 500", async () => {
      const params = TestUtil.defaulHandleParams();
      params.request.method = "GET";
      params.request.url = "/index.png";
